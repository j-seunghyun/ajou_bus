...
const { basicResponse, resultResponse, ALL_SEME_STATION, ALL_VACA_STATION, DB_ERROR,  } = require("../../config/response");
...
exports.semesterInfo = async function(req, res){
    try{
        ...
        return res.send(resultResponse(ALL_SEME_STATION, data));
...
exports.vacationInfo = async function(req, res){
    try{
        ...
        if(!data) return res.send(basicResponse(DB_ERROR));
        return res.send(resultResponse(ALL_VACA_STATION, data));
